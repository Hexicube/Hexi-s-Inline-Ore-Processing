...
%blenderDirectory% %projectName%.blend -o //render/HR/render_### -F PNG -b -t 3 -j 8 -a
python _spritesheet2.py render/HR/ render/%projectName%_TEST --resolution 1024 --halve True
